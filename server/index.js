...
For every document, extract purchaseDate as YYYY-MM-DD only when confidently visible. Do not invent a date. Extract receiptTotal as the final amount, tax as tax or admin fee, serviceCharge as service fee, and discount as a positive discount. Use 0 for absent charges. All monetary values must be numbers without currency symbols or separators.
`.trim();
